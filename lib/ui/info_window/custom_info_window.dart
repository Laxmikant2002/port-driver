...
class CustomInfoWindowController {
  ...
  void Function(Widget, LatLng)? addInfoWindow;
...
class CustomInfoWindow extends StatefulWidget {
  ...
  const CustomInfoWindow({required this.controller, super.key,
    this.offset = 50,
    this.height = 50,
    this.width = 100,
  })  : assert(offset >= 0),
...
class _CustomInfoWindowState extends State<CustomInfoWindow> {
  ...
  Future<void> _updateInfoWindow() async {
    if (_latLng == null ||
      ...
      final a = widget.controller.googleMapController;
      print('$_latLng, $_child, $a');
      return;
    } else {
      print('ABCD');
    }
