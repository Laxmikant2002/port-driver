...
class MainRoutes {
  ...
  static Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      dashboard: (context) => const modern_navigation.MainNavigationScreen(),
      workAreaSelection: (context) => const WorkAreaSelectionScreen(),
      goOnline: (context) => const modern_navigation.MainNavigationScreen(),
      goOffline: (context) => const modern_navigation.MainNavigationScreen(),
